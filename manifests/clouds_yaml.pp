...
#
# [*cache*]
#   Cache section for clouds.yaml
#
# [*client*]
#   Client section for clouds.yaml
#
# [*clouds*]
#   Clouds (or public-clouds) section for clouds.yaml
#
# [*ensure*]
#   Metaparameter 'ensure' for file resource
#
# [*group*]
#   Group for resulting file
#
# [*perms*]
#   Unix permissions for created clouds.yaml
#
# [*profiles*]
#   Wheither file contains public clouds configuration (cloud profiles)
#
# [*secure*]
#   Wheither file contains sensitive information (authentication data)
#
# [*user*]
#   Owner of created clouds.yaml
#
# [*home*]
#   Owner's home direstory ('/home/$user' by default)
#
...
define os_client_config::clouds_yaml (
  ...
  if ( $user ) {
    $_user_home = pick( $home, "/home/${user}" )
